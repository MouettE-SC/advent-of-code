# Imported from https://github.com/hyper-neutrino/advent-of-code/blob/main/2023/day21p2.py
# Explained in https://www.youtube.com/watch?v=9UOMZSL0JTg
# Wanted to go this way but lacked time and commitment, may come back later writing
# this on my own.

from collections import deque

grid = open('day-21.input').read().splitlines()
