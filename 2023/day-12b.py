# taken from https://www.reddit.com/r/adventofcode/comments/18ge41g/comment/kd0ig1u/?utm_source=share&utm_medium=web2x&context=3

from functools import cache

@cache # too slow without the cache - stores function values
def numlegal(s, c):
