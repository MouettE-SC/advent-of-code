...
# This one works by replacing the following input lines :
#
# cpy b c
# inc a
# dec c
...
#  jnz 0 0
#
# mul does increase a with the product of b and d ; then the next two cpy zero c and d ; the jnz are noop
